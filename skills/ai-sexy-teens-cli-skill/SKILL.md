---
name: ai-sexy-teens-cli-skill
description: AI sexy teens — transform a person photo into a bikini model image or video
compatibility: Requires weshop-cli (npm install -g weshop-cli) and WESHOP_API_KEY environment variable
metadata: {"openclaw": {"requires": {"env": ["WESHOP_API_KEY"], "commands": ["weshop"]}, "primaryEnv": "WESHOP_API_KEY"}}
---
# WeShop CLI Skill — ai-sexy-teens
...
Examples:
  weshop ai-sexy-teens --image ./person.png --prompt 'Bikini model on a beach'
  weshop ai-sexy-teens --image ./person.png --generated-type image --batch 2
