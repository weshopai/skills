---
name: custom-bikini-cli-skill
description: Custom bikini — transform a person photo into a bikini model image or video
...
Examples:
  weshop custom-bikini --image ./person.png --prompt 'Bikini model on a beach'
  weshop custom-bikini --image ./person.png --generated-type image --batch 2
