...
- **Name:** `free-4k-video-upscaler`
- **Version:** `v1.0`
- **Description:** Upscale video to 4K resolution using AI
...
```json
{
  "agent": { "name": "free-4k-video-upscaler", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
