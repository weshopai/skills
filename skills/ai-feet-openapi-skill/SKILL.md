...
- **Name:** `ai-feet`
- **Version:** `v1.0`
- **Description:** Generate a realistic low-angle bare feet photo from a portrait
...
```json
{
  "agent": { "name": "ai-feet", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
