...
- **Name:** `ai-lingerie-models`
- **Version:** `v1.0`
- **Description:** Transform a person photo into a lingerie/bikini model image or video
...
```json
{
  "agent": { "name": "ai-lingerie-models", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
