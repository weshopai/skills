---
name: string-bikini-beauty-contest-openapi-skill
...
---
# WeShop OpenAPI Skill — string-bikini-beauty-contest
...
- **Name:** `string-bikini-beauty-contest`
- **Version:** `v1.0`
- **Description:** Transform a person photo into a bikini beauty contest image or video
...
```json
{
  "agent": { "name": "string-bikini-beauty-contest", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
