---
name: ai-lingerie-models-cli-skill
description: AI lingerie models — transform a person photo into a bikini model image or video
compatibility: Requires weshop-cli (npm install -g weshop-cli) and WESHOP_API_KEY environment variable
metadata: {"openclaw": {"requires": {"env": ["WESHOP_API_KEY"], "commands": ["weshop"]}, "primaryEnv": "WESHOP_API_KEY"}}
---
# WeShop CLI Skill — ai-lingerie-models

## Overview

AI lingerie models — transform a person photo into a bikini model image or video

🌐 **Official page:** https://www.weshop.ai/tools/ai-lingerie-models
...
Examples:
  weshop ai-lingerie-models --image ./person.png --prompt 'Bikini model on a beach'
  weshop ai-lingerie-models --image ./person.png --generated-type image --batch 2
