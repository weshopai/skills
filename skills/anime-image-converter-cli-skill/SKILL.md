---
name: anime-image-converter-cli-skill
description: AI anime image converter — transform any photo into anime art style
compatibility: Requires weshop-cli (npm install -g weshop-cli) and WESHOP_API_KEY environment variable
metadata: {"openclaw": {"requires": {"env": ["WESHOP_API_KEY"], "commands": ["weshop"]}, "primaryEnv": "WESHOP_API_KEY"}}
---
# WeShop CLI Skill — anime-image-converter
...
**`weshop anime-image-converter`**

Convert any photo into anime-style artwork.

Default prompt: "Turn this photo into anime."
...
| --- | --- | --- | --- | --- |
| `--image` | array | Yes |  |  |
| `--prompt` | string | No | `Turn this photo into anime.` |  |
| `--batch` | integer | No | `1` |  |
