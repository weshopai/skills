...
- **Name:** `sonic-oc`
- **Version:** `v1.0`
- **Description:** Create a Sonic the Hedgehog original character based on a person's appearance
...
```json
{
  "agent": { "name": "sonic-oc", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
