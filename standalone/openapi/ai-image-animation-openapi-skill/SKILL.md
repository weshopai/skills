...
- **Version:** `v1.0`
- **Description:** Animate a static image into a dynamic video using Kling
...
```json
{
  "agent": { "name": "ai-image-animation", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
