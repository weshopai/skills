...
- **Name:** `bald-filter`
- **Version:** `v1.0`
- **Description:** Make a person appear bald while preserving facial details
...
```json
{
  "agent": { "name": "bald-filter", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
