---
name: ai-sexy-portrait-cli-skill
description: AI sexy portrait — transform a person photo into a bikini model image or video
compatibility: Requires weshop-cli (npm install -g weshop-cli) and WESHOP_API_KEY environment variable
metadata: {"openclaw": {"requires": {"env": ["WESHOP_API_KEY"], "commands": ["weshop"]}, "primaryEnv": "WESHOP_API_KEY"}}
---
# WeShop CLI Skill — ai-sexy-portrait

## Overview

AI sexy portrait — transform a person photo into a bikini model image or video

🌐 **Official page:** https://www.weshop.ai/tools/ai-sexy-portrait
...
Examples:
  weshop ai-sexy-portrait --image ./person.png --prompt 'Bikini model on a beach'
  weshop ai-sexy-portrait --image ./person.png --generated-type image --batch 2
