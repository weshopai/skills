---
name: hot-bikini-models-cli-skill
...
---
# WeShop CLI Skill — hot-bikini-models
...
Examples:
  weshop hot-bikini-models --image ./person.png --prompt 'Bikini model on a beach'
  weshop hot-bikini-models --image ./person.png --generated-type image --batch 2
