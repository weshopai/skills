...
- **Version:** `v1.0`
- **Description:** Create clear flowchart images from process descriptions without any image input
...
```json
{
  "agent": { "name": "flowchart-generator", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
