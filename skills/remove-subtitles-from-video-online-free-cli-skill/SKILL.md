---
name: remove-subtitles-from-video-online-free-cli-skill
description: Remove subtitles from video online free — remove subtitles or text overlays from a video
compatibility: Requires weshop-cli (npm install -g weshop-cli) and WESHOP_API_KEY environment variable
metadata: {"openclaw": {"requires": {"env": ["WESHOP_API_KEY"], "commands": ["weshop"]}, "primaryEnv": "WESHOP_API_KEY"}}
---
# WeShop CLI Skill — remove-subtitles-from-video-online-free
...
**`weshop remove-subtitles-from-video-online-free`**
...
```
[result]
  agent: remove-subtitles-from-video-online-free
  executionId: <id>
  status: Success
  videoCount: N
  video[0]:
