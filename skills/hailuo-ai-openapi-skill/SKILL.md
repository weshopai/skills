...
---
# WeShop OpenAPI Skill — hailuo-ai
...
- **Name:** `hailuo-ai`
- **Version:** `v1.0`
- **Description:** Cinematic AI video generation with MiniMax Hailuo models
...
```json
{
  "agent": { "name": "hailuo-ai", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
