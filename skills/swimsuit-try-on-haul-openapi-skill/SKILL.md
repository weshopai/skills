...
- **Name:** `swimsuit-try-on-haul`
- **Version:** `v1.0`
- **Description:** Transform a person photo into a swimsuit try-on image or video
...
```json
{
  "agent": { "name": "swimsuit-try-on-haul", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
