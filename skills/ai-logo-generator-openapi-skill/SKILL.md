---
name: ai-logo-generator-openapi-skill
...
---
# WeShop OpenAPI Skill — ai-logo-generator
...
- **Version:** `v1.0`
- **Description:** Design brand logos directly from text descriptions of brand name, industry, and style
...
```json
{
  "agent": { "name": "ai-logo-generator", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
