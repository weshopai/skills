---
name: ai-swimsuit-model-openapi-skill
description: AI swimsuit model — transform a person photo into a swimsuit model image
compatibility: Requires HTTPS access to openapi.weshop.ai
metadata: {"openclaw": {"requires": {"env": ["WESHOP_API_KEY"]}, "primaryEnv": "WESHOP_API_KEY"}}
---
# WeShop OpenAPI Skill — ai-swimsuit-model
...
- **Name:** `ai-swimsuit-model`
- **Version:** `v1.0`
- **Description:** Transform a person photo into a swimsuit model image
...
```json
{
  "agent": { "name": "ai-swimsuit-model", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
