---
name: free-sexy-ai-generator-cli-skill
description: Free sexy AI generator — transform a person photo into a bikini model image or video
compatibility: Requires weshop-cli (npm install -g weshop-cli) and WESHOP_API_KEY environment variable
metadata: {"openclaw": {"requires": {"env": ["WESHOP_API_KEY"], "commands": ["weshop"]}, "primaryEnv": "WESHOP_API_KEY"}}
---
# WeShop CLI Skill — free-sexy-ai-generator
...
Examples:
  weshop free-sexy-ai-generator --image ./person.png --prompt 'Bikini model on a beach'
  weshop free-sexy-ai-generator --image ./person.png --generated-type image --batch 2
