...
- **Name:** `kling`
- **Version:** `v1.0`
- **Description:** AI video generation from images and text using Kling. Pass one image for first-frame image-to-video, or two images for first frame + last frame.
