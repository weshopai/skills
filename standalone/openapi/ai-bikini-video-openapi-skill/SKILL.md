...
- **Name:** `ai-bikini-video`
- **Version:** `v1.0`
- **Description:** Generate a bikini dance video from a person photo
...
```json
{
  "agent": { "name": "ai-bikini-video", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
