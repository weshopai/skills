---
name: bikini-contest-photos-cli-skill
description: Bikini contest photos — transform a person photo into a bikini model image or video
compatibility: Requires weshop-cli (npm install -g weshop-cli) and WESHOP_API_KEY environment variable
metadata: {"openclaw": {"requires": {"env": ["WESHOP_API_KEY"], "commands": ["weshop"]}, "primaryEnv": "WESHOP_API_KEY"}}
---
# WeShop CLI Skill — bikini-contest-photos
...
Examples:
  weshop bikini-contest-photos --image ./person.png --prompt 'Bikini model on a beach'
  weshop bikini-contest-photos --image ./person.png --generated-type image --batch 2
