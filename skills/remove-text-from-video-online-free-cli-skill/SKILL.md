---
name: remove-text-from-video-online-free-cli-skill
...
---
# WeShop CLI Skill — remove-text-from-video-online-free
...
**`weshop remove-text-from-video-online-free`**
...
```
[result]
  agent: remove-text-from-video-online-free
  executionId: <id>
  status: Success
  videoCount: N
  video[0]:
