...
description: Seedance video generator — create cinematic AI videos using Seedance 2.0, 2.0 Mini, or 1.0 by ByteDance
...
Seedance video generator — create cinematic AI videos using Seedance 2.0, 2.0 Mini, or 1.0 by ByteDance
...
Agent version stays v1.0; existing Seedance_20 / 1.0 model names are unchanged. Seedance_20_Mini is additive.
...
Duration (--duration):
  Seedance_20/20_Mini: 4s-15s  (default: 4s)
  Seedance_10_Pro/Fast: 2s-12s  (default: 4s)

Aspect ratio (--aspect-ratio):
  Seedance_20/20_Mini: 21:9, 16:9, 9:16, 3:4, 4:3, 1:1  (default: 3:4)
...
| `--image` | array (1–9) | Yes |  |  |
| `--prompt` | string | Yes |  |  |
| `--model` | string | No | `Seedance_20` | `Seedance_20`, `Seedance_20_Mini`, `Seedance_10_Pro`, `Seedance_10_Pro_Fast` |
