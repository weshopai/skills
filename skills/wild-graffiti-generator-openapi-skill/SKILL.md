---
name: wild-graffiti-generator-openapi-skill
...
---
# WeShop OpenAPI Skill — wild-graffiti-generator
...
- **Name:** `wild-graffiti-generator`
- **Version:** `v1.0`
- **Description:** Create wild-style spray paint graffiti art from text or image
...
```json
{
  "agent": { "name": "wild-graffiti-generator", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
