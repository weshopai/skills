...
- **Name:** `ai-pants-remover`
- **Version:** `v1.0`
- **Description:** Transform pants outfit photos into bikini look images or videos
...
```json
{
  "agent": { "name": "ai-pants-remover", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
