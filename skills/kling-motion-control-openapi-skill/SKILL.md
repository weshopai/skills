---
name: kling-motion-control-openapi-skill
...
---
# WeShop OpenAPI Skill — kling-motion-control
...
- **Version:** `v1.0`
- **Description:** Motion transfer from reference video to character image with Kling Motion Control
...
```json
{
  "agent": { "name": "kling-motion-control", "version": "v1.0" },
  "input": {
    "originalImage": "https://..."
  },
  "params": {
